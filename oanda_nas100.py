...
class OandaDataFetcher:
    ...
    def get_candlestick_data(self, 
        ...
        Args:
            instrument: Trading instrument (e.g., "NAS100_USD")
...
def main():
    ...
    # Check if NAS100 is available (try different naming conventions)
    nas100_variants = ["NAS100_USD", "NAS100", "US100", "US100_USD"]
    valid_instrument = None
    
    for variant in nas100_variants:
    ...
    if not valid_instrument:
        print("NAS100 not found. Available instruments:")
